          ...
          <div className="bg-white dark:bg-slate-900 rounded-xl shadow-lg overflow-hidden">
            ...
            <div className="p-4">
              <textarea
                ...
                className="w-full h-48 p-4 font-mono text-sm bg-slate-50 dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none resize-none"
                spellCheck={false}
              />
            </div>
